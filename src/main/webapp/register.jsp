						...
						<form>
							<div class="form-group">
								<label for="exampleInputName"></label> <input type="text"
									...
									aria-describedby="nameHelp" placeholder="Enter Your Name" required="required" name="fname">
							...
							<div class="form-group">
								<label for="exampleInputPhonenumber"> </label> <input
									...
									placeholder="Enter Phone Number" required="required" name="phoneno"> 
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1"></label> <input
									type="password" class="form-control" id="exampleInputPassword1" placeholder="Your Password" required="required" name="password">
							</div>
